...
import { Search, Settings, LogOut, Filter, Loader2 } from 'lucide-react'
...
export default function DashboardPage() {
  ...
  // Enforce authentication - redirect if not authenticated
  useEffect(() => {
  ...
  // Redirect will happen via useEffect above, but this prevents rendering if not authenticated
  if (!isAuthenticated) {
    return null
  }
